...
using Playnite.Legacy.Extensions.Markup;
...
namespace Playnite.Legacy
{
    public class ThemeManager
    {
        ...
        public static Version DesktopApiVersion => new Version("2.8.0");
        public static Version FullscreenApiVersion => new Version("2.8.0");
        ...
        public static void ApplyFullscreenButtonPrompts(Application app, FullscreenButtonPrompts prompts)
        {
            ...
            {
                var promptsPath = Path.Combine(DefaultTheme.DirectoryPath, "Images", "ButtonPrompts");
