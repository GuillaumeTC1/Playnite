...
namespace Playnite.Legacy.Native
{
    public class Wintrust
    {
        internal sealed class UnmanagedPointer : IDisposable
        {
            ...
            internal UnmanagedPointer(nint ptr, WINTRUST_DATA.AllocMethod method)
            {
                m_meth = method;
                m_ptr = ptr;
            }
            ...
            public static implicit operator nint(UnmanagedPointer ptr)
            {
                return ptr.m_ptr;
            }
        }
    ...
    internal struct WINTRUST_DATA : IDisposable
    {
        ...
        public nint pSIPCallbackData;
        public UiChoice dwUIChoice;
        public RevocationCheckFlags fdwRevocationChecks;
        public UnionChoice dwUnionChoice;
        public nint pInfoStruct;
        public StateAction dwStateAction;
        public nint hWVTStateData;
        private nint pwszURLReference;
