...
using Playnite.Legacy.API;
using Playnite.Legacy.Commands;
using Playnite.Legacy.Common;
using Playnite.Legacy.Common.Extensions;
using Playnite.Legacy.Common.Web;
using Playnite.Legacy.Controllers;
using Playnite.Legacy.Controls;
using Playnite.Legacy.Localization;
using Playnite.Legacy.Manifests;
using Playnite.Legacy.Plugins;
using Playnite.Legacy.Services;
using Playnite.Legacy.Settings;
using Playnite.Legacy.ViewModels;
using Playnite.Legacy.Windows;
using Playnite.SDK;
...
namespace Playnite.Legacy.App
{
    public abstract class PlayniteApplication : ObservableObject, IPlayniteApplication
    {
            ...
            CmdLineOptions cmdLine)
        {
            ...
            GlobalCommands.AppSettings = AppSettings;
            ...
            else
            {
                ...
                if (mode == ApplicationMode.Desktop)
                {
                    WindowBase.SetTextRenderingOptions(AppSettings.TextFormattingMode, AppSettings.TextRenderingMode);
                }
        ...
        public void UpdateScreenInformation(WindowBase window)
        {
            try
            {
