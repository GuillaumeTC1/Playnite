...
using Playnite.Legacy.Extensions;
using Playnite.Legacy.Scripting;
...
namespace Playnite.Legacy
{
    public class MenuItems
    {
        ...
        public static List<SearchItem> GetSearchExtensionsMainMenuItem(MainViewModelBase model)
        {
            ...
            {
                if (script.SupportedMenus.Contains(SupportedMenuMethods.MainMenu))
                {
                    try
                    {
        ...
        public static List<SearchItem> GetSearchGameMenuItems(Game game, MainViewModelBase model)
        {
            ...
            foreach (var script in model.Extensions.Scripts)
            {
                if (script.SupportedMenus.Contains(SupportedMenuMethods.GameMenu))
                {
                    try
                    {
