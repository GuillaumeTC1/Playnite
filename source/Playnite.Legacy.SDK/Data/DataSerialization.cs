...
namespace Playnite.Legacy.SDK.Data
{
    /// <summary>
    ...
    public class Serialization
    {
        ...
        {
            return serializer.TryFromYaml(yaml, out content);
        }
        ...
        {
            return serializer.TryFromYaml(yaml, out content, out error);
        }
        ...
        {
            return serializer.TryFromYamlFile(filePath, out content);
        }
        ...
        {
            return serializer.TryFromYamlFile(filePath, out content, out error);
        }
        ...
        {
            return serializer.TryFromJson(json, out content);
        }
        ...
        {
            return serializer.TryFromJson(json, out content, out error);
        }
        ...
        {
            return serializer.TryFromJsonStream(stream, out content);
        }
        ...
        {
            return serializer.TryFromJsonStream(stream, out content, out error);
        }
        ...
        {
            return serializer.TryFromJsonFile(filePath, out content);
        }
        ...
        {
            return serializer.TryFromJsonFile(filePath, out content, out error);
        }
        ...
        {
            return serializer.TryFromToml(toml, out content);
        }
        ...
        {
            return serializer.TryFromToml(toml, out content, out error);
        }
        ...
        {
            return serializer.TryFromTomlFile(filePath, out content);
        }
        ...
        {
            return serializer.TryFromTomlFile(filePath, out content, out error);
        }
        ...
        {
            return serializer.GetClone(source);
        }
