namespace Playnite
{
    public class CefTools
    {
        ...
        {
            throw new NotImplementedException("CefTools.ConfigureCef is not implemented in Playnite 10. Use CefTools.Initialize instead.");
        ...
        {
            throw new NotImplementedException("CefTools.Shutdown is not implemented in Playnite 10. Use CefTools.Dispose instead.");
            //Cef.Shutdown();
            //IsInitialized = false;
        }
    }
